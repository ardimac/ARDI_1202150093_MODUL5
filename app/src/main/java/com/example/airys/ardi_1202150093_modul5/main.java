...
public class main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipe swipeToDelete = new swipe(main.this, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(main.this, AddNewRecord.class);
                startActivity(i);
            }
        });
    }
    ...
    private swipe.SwipetoDismissCallBack getCallback(final todoAdapter adapter) {
        return new swipe.SwipetoDismissCallBack() {
            ...
            public void onSwipedRight(RecyclerView.ViewHolder viewHolder) {
                Toast.makeText(main.this, "Another or same action", Toast.LENGTH_SHORT).show();
            }
        };
    }
